...
if (WIN32)
    ...
    if (APPLE)
        ...
        if(X11_Xrandr_FOUND AND X11_xf86vmode_FOUND AND X11_Xcursor_FOUND AND X11_Xinerama_FOUND)
			 list(APPEND GLFW_x11_LIBRARY  -lrt -lm -ldl "${X11_Xrandr_LIB}" "${X11_Xinerama_LIB}" "${X11_Xxf86vm_LIB}" "${X11_Xcursor_LIB}" "${X11_Xext_LIB}" "${X11_Xrender_LIB}" "${CMAKE_THREAD_LIBS_INIT}" -lXi)
